...
ALTER TABLE olist_staging.stg_order ADD INDEX idx_customer_id (customer_id);
ALTER TABLE olist_staging.stg_customer ADD INDEX idx_customer_unique_id (customer_unique_id);
