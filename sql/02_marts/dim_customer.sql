...
-- Resolution path: stg_orders.customer_id -> stg_customer.customer_id -> stg_customer.customer_unique_id.
...
WITH customer_latest AS (
    ...
    FROM olist_staging.stg_customer as c
    INNER JOIN olist_staging.stg_orders as o
